...
class ConfirmBooking extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final num unitPrice = num.tryParse(destEntryFee) ?? 0;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Consumer<MainProvider>(builder: (context, dValue, child) {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "This venue supports booking cancellation. To know more view",
                      ...
                      child: Consumer<MainProvider>(
                        ...
                        return ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            final selectedDate =
                                context.read<MainProvider>().selectedDate;
                            if (selectedDate == null) {
                              ...
                              callNext(
                                  ...
                                  PaymentScreen(
                                    ...
                                    destEntryFee: destEntryFee,
                                    destImage: destImage,
                                    selectedCount: selectedCount,
                                    totalAmount: totalAmount,
                                    subTotal: totalFee,//pass subtotal as a string
                                  ));
                            }
                          },
                          child: const Text(
