...
class GetAllReceiptScreen extends StatelessWidget {
  final DestTicketModel ticket; // Accept the clicked ticket data

  GetAllReceiptScreen({Key? key, required this.ticket}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    var travelDate = DateFormat('dd MMM yyyy').format(DateTime.parse(ticket.travelDate));
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Destination: ${ticket.destName}', style: TextStyle(fontSize: 16)),
                      Text('Place: ${ticket.destPlace}', style: TextStyle(fontSize: 16)),
                      Text('District: ${ticket.destDistrict}', style: TextStyle(fontSize: 16)),
                    ],
                  ),
                ),
              ),
